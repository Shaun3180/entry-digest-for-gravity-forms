...
= 1.5.1 =
* Polish: the send-log retention control now appears only alongside the send-log table (not on the empty first-run screen), and its heading no longer carries a redundant "(Pro)" label.
